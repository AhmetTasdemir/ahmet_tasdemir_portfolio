...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled web developer with experience in TypeScript and JavaScript, and expertise in technologies like React, Next.js, and Redux. 
